...
Mem =["constant","global","readonly","texture","texture","global","readonly","texture","texture"]
...
# print state
 ...
 if j == 2:
  if p[k][j][0] == 99999999:
   ...
   latency =p[k][j][1]* p[k][j][1]/conten[L1["L1_readonly"]]*read_lat[2]+p[k][j][2]*p[k][j][2]/conten[L2["L2_readonly"]]*read_lat[1]+(p[k][j][0]-p[k][j][1]*p[k][j][1]/conten[L1["L1_readonly"]]-p[k][j][2]*p[k][j][2]/conten[L2["L2_readonly"]])*read_lat[0]
   return latency
 ...
 if j == 6:
  if p[k][j][0] == 99999999:
   ...
   #print(p_shared[k])
   latency = p[k][j][1]*p[k][j][1]/conten[L1["L1_readonly"]]*read_lat[2]+p[k][j][2]*p[k][j][2]/conten[L2["L2_readonly"]]*read_lat[1]+(p[k][j][0]-p[k][j][1]*p[k][j][1]/conten[L1["L1_readonly"]]-p[k][j][2]*p[k][j][2]/conten[L2["L2_readonly"]])*read_lat[0] + p_shared[k]*sh_lat
  return latency
 if j == 7 or j ==8:
  if p[k][j][0] == 99999999:
   return(999999999)
