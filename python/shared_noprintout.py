...
exe_command = "./readonly_noprint.py "+readonly_info[1]+" "+readonly_info[2]+" "+readonly_info[3]+" "+readonly_info[4]+" "+readonly_info[5]+" "+readonly_info[6]+" "+readonly_info[7]+" "+readonly_info[8]+" ldshared.txt"
os.system(exe_command)
out = open("output.txt",'a')
out.write("- ")
out.close()
if dimension[0] == 2:
 exe_command = "./1Dtexture_noprint.py "+s[1]+" "+s[4]+" "+s[5]+" "+s[6]+" "+s[7]+" "+s[8]+" "+s[9]+" "+s[10]+" ldshared.txt"
 os.system(exe_command)
 out = open("output.txt",'a')
 out.write("- ")
 out.close()
 exe_command = "./2Dtexture_noprintout.py "+s[2]+" "+s[3]+" "+s[4]+" "+s[5]+" "+s[6]+" "+s[7]+" "+s[8]+" "+s[9]+" "+s[10]+" "+str(sys.argv[4])#" ldshared.txt"
 os.system(exe_command)
else:
 exe_command = "./1Dtexture_noprint.py "+s[1]+" "+s[4]+" "+s[5]+" "+s[6]+" "+s[7]+" "+s[8]+" "+s[9]+" "+s[10]+" ldshared.txt"
 os.system(exe_command)
